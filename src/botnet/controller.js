...
import { getServers, copyScripts, checkTarget, isPrepped, prep} from "botnet/utils_old.js";
import { settings } from "../aux/SingleSourceOfTruth.js";
//import { Job, Metrics, RamNet, ProgressMonitor } from "botnet/utils.js";

// Constants
const TYPES = ["hack", "weaken1", "grow", "weaken2"];
const WORKERS = ["/botnet/tHack.js", "/botnet/tWeaken.js", "/botnet/tGrow.js"];
const SCRIPTS = { hack: "/botnet/tHack.js", weaken1: "/botnet/tWeaken.js", grow: "/botnet/tGrow.js", weaken2: "/botnet/tWeaken.js" };
...
function getSelectedTarget() {
	return settings.batcherTarget;
}

export async function batcher(ns, preferredTarget) {
	while (true) {
		// Setup is mostly the same.
		const dataPort = ns.getPortHandle(ns.pid);
		dataPort.clear();
		let target = getSelectedTarget() || preferredTarget || "n00dles";
